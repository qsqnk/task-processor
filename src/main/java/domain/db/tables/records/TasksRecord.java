...
public class TasksRecord extends UpdatableRecordImpl<TasksRecord> implements Record6<Long, String, Taskstatus, LocalDateTime, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public Row6<Long, String, Taskstatus, LocalDateTime, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public Field<Taskstatus> field3() {
    ...
    @Override
    public TasksRecord value3(Taskstatus value) {
        setStatus(value);
        return this;
    }
    ...
    @Override
    public TasksRecord values(Long value1, String value2, Taskstatus value3, LocalDateTime value4, LocalDateTime value5, LocalDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TasksRecord(Long id, String name, Taskstatus status, LocalDateTime scheduledTs, LocalDateTime createdTs, LocalDateTime updatedTs) {
        super(Tasks.TASKS);
